  ...
  <div class="catItemBody">
	  ...
	  <div class="catItemImageBlock">
		  <span class="catItemImage">
		    <a rel="{handler: 'image'}" class="modal" href="<?php echo $this->item->imageXLarge; ?>" title="<?php if(!empty($this->item->image_caption)) echo $this->item->image_caption; else echo $this->item->title; ?>">
