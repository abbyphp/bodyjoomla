		...
		<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
			<div class="itemImageBlock">
				<span class="itemImage">
					<?php if(empty($this->item->imageXLarge)): ?>
...
<!-- Image credits -->
		...
		<?php if($this->item->params->get('itemHits') || ($this->item->params->get('itemDateModified') && intval($this->item->modified)!=0) || $this->item->params->get('itemAuthor')): ?>
...
<!-- Item category -->
		<?php if($this->item->params->get('itemCategory')): ?>
			<div class="itemCategory">
				<a href="<?php echo $this->item->category->link; ?>"><?php echo JText::_('K2_ZOOM_ITEM_CATEGORY'); ?></a>
			</div>
		<?php endif; ?>
...
<!-- Item Hits -->
				<?php if($this->item->params->get('itemHits')): ?>
					<span class="itemHits">
						<?php echo JText::_('K2_READ'); ?> <?php echo $this->item->hits; ?>
					</span>
				<?php endif; ?>
...
<!-- Item attachments -->
			<?php if($this->item->params->get('catItemAttachments') && count($this->item->attachments)): ?>
				<div class="catItemAttachmentsBlock">
					<span><?php echo JText::_('K2_DOWNLOAD_TIMETABLE'); ?></span>
					...
					<li>
						...
						<div class="fileSize"><?php echo '['.floor(round(filesize('media/k2/attachments/'.$attachment->filename)/1024)).'KB]'; ?></div>
