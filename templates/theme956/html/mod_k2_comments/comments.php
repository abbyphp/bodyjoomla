	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?>">
			...
			<span class="lcCommentDate">
				...
				<?php else: ?>
				<?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC5')); ?>
				<?php endif; ?>
			</span>
			<?php endif; ?>
			...
			<?php if($params->get('commentLink')): ?>
				<a class="k2ReadMore" href="<?php echo $comment->link; ?>"><?php echo JText::_('K2_READ_MORE_THEME'); ?></a>
				<?php else: ?>
			<?php endif; ?>
